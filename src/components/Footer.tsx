    ...
    <footer className="bg-primary border-t border-border">
      <div className="container py-16">
        <div className="grid md:grid-cols-3 gap-10 mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white/60 text-xs font-medium uppercase tracking-widest mb-5">빠른 링크</h4>
          ...
          {/* Social */}
          <div>
            <h4 className="text-white/60 text-xs font-medium uppercase tracking-widest mb-5">소셜</h4>
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-surface border border-border flex items-center justify-center text-white/40
